...
For {pros_count} opinions list of advantages id available
For {cons_count} opinions list of disadvanatages i available.
Average score is bases on opinions stars is equal to {average_score:.1f}""")
